...
import { getFormattedDateReminders } from '../../selectors/calendar';
import { editReminder, newReminder } from '../../actions/reminder';
    ...
    <li
      ...
      className={classNames(
        'h-auto px-3 py-2 bg-white text-lg overflow-hidden',
        {
          ...
          'text-red-600 font-bold': date.isWeekend && !date.trailing,
